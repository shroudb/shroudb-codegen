//! Transport interface, RESP3 codec, and HTTP transport generation.

use crate::generator::GeneratedFile;
use crate::unified::ir::UnifiedIR;

pub(super) fn generate(_ir: &UnifiedIR) -> Vec<GeneratedFile> {
    vec![gen_interface(), gen_resp3(), gen_http()]
}

fn gen_interface() -> GeneratedFile {
    GeneratedFile {
        path: "src/transport/interface.ts".into(),
...
fn gen_resp3() -> GeneratedFile {
    GeneratedFile {
        path: "src/transport/resp3.ts".into(),
        content: r#"// Auto-generated by shroudb-codegen. Do not edit.
...
fn gen_http() -> GeneratedFile {
    GeneratedFile {
        path: "src/transport/http.ts".into(),
        content: r#"// Auto-generated by shroudb-codegen. Do not edit.
